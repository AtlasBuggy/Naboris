...
class Logger(BaseWriteFile):
    ...
    def __init__(self, stream_name, file_name=None, directory=None):
        ...
        super(Logger, self).__init__(stream_name, file_name, directory, True, log_file_type, log_dir, True, enable_dumping=False)
...
class Parser(BaseReadFile):
    ...
    def __init__(self, stream_name, file_name, directory=None, start_index=0, end_index=-1):
        ...
        """
        super(Parser, self).__init__(stream_name, file_name, directory, True, log_file_type, log_dir, True)
        self.open()
