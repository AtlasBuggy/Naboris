...
#define YAW_PIN 10
#define NUM_MOTORS 4
#define TOPLEFT_OFFSET 45
#define BOTLEFT_OFFSET 0
#define TOPRIGHT_OFFSET 45
...
void update_encoders()
{
    ...
    if (millis() - prev_enc_time > 100) {
        ...
        if (newRightPosition != oldLeftPosition) {
            oldLeftPosition = newRightPosition;
            Serial.print("er");
            Serial.print(newRightPosition);
            Serial.print('\n');
        }

        if (newLeftPosition != oldRightPosition) {
            oldRightPosition = newLeftPosition;
            Serial.print("el");
